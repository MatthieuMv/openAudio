...
// Note réference: A4 -> la3

static const oA::Float noteFrequencies[9][12] {
    { 16.35,   17.32,   18.35,   19.45,   20.60,   21.83,   23.12,   24.50,   25.96,   27.50,   29.14,   30.87 },
    { 32.70,   34.65,   6.71,    38.89,   41.20,   43.65,   46.25,   49.00,   51.91,   55.00,   58.27,   61.74 },
...
{
    oA::UInt volume;
    oA::Pair<UInt, UInt> value; // Scale, note (ex: Do2 -> )
    oA::UInt velocity;
};
